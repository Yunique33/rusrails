...
Rails требует, чтобы был установлен Ruby версии 2.7.0 или новее. Предпочтительно использовать последнюю версию Ruby. Если номер версии меньше этой (такой как 2.3.7 или 1.8.7), нужно будет установить новую копию Ruby.
...
Проверьте, что он правильно установлен и путь к нему добавлен в переменную окружения `PATH`:
